...
function CompanyClient () {
  ...
  return (
    <div className="flex flex-col gap-[37px] mt-[60px] mb-[83px] text-grey-dark">
      ...
      <section 
        id={styles.section2}
        className="pt-[73px] pb-[94px] bg-secondary"
      >
        <div className="w-[80%] flex flex-col mx-auto gap-[17px] md:w-full md:mx-0">
          ...
          <div className="flex flex-col gap-[20px]">
            <div className="flex gap-[20px]">
              <Input placeholder={t("companyClient.section2.searchBarPlaceholder")} className="w-[42%] h-[40px] border-grey-dark p-[9px] rounded-[8px]"/>
