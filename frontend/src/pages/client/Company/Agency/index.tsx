...
function AgencyClient () {
  ...
  const request = useQuery<Agency>(['getAgency', url], async () => {
  ...
  return (
    <div className="flex flex-col gap-[50px] mt-[60px] mb-[83px] text-grey-dark">
      <section className="w-[80%] mx-auto md:w-full md:mx-0">
        ...
        <p>
          Nous sommes un réseau d'auto-écoles et de centres de formation. Créé en 1983, CER est un réseau de plus de 550 enseignes sur toute la France.
        </p>
      </section>
      <section 
        id={styles.section2}
        className="pt-[40px] pb-[60px] bg-secondary"
      >
        <div className="w-[80%] mx-auto md:w-full md:mx-0">
          ...
          <div className="flex gap-[20px] mt-[17px]">
            <div className="w-[480px] h-[270px] bg-background">
      ...
      <section className="w-[80%] mx-auto md:w-full md:mx-0 flex flex-col gap-[17px]">
        ...
        <div className="flex gap-[5px]">
          ...
          <p className="underline">{request.data?.address}, {request.data?.zip} {request.data?.city}</p>
        </div>
      ...
      <section className="w-[80%] mx-auto md:w-full md:mx-0 flex flex-col gap-[17px]">
        ...
        <div className="flex gap-[40px]">
          <div className="flex flex-col items-center gap-[15px]">
            <img className="rounded-[200px] w-[200px] h-[200px]" alt="monititor-picture" src="https://yt3.googleusercontent.com/bVsqJPvzGWmifywdIj9srMNA-39rStHuPm4KOuVac9CVM3uMegew_he4Btnq4EdMfwBsEexMmQ=s900-c-k-c0x00ffffff-no-rj"/>
            <p>Nom Prénom</p>
          </div>
          <div className="flex flex-col items-center gap-[15px]">
            <img className="rounded-[200px] w-[200px] h-[200px]" alt="monititor-picture" src="https://yt3.googleusercontent.com/bVsqJPvzGWmifywdIj9srMNA-39rStHuPm4KOuVac9CVM3uMegew_he4Btnq4EdMfwBsEexMmQ=s900-c-k-c0x00ffffff-no-rj"/>
