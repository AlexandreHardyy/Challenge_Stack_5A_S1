...
export const DateRangePickerCustom: FC<DateRangePickerProps> & {
  filePath: string
} = ({
  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <Button className="w-[305px]" variant="outline">
...
DateRangePickerCustom.filePath = "libs/shared/ui-kit/src/lib/date-range-picker/date-range-picker.tsx"
